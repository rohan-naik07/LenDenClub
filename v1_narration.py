...
check_narration = ['POS 405988XXXXXX3789 PAYU-LAZYPAY REP', '109869108846/CCABAJAJFINSERV','E5L9EFXJFQH7OB/RAZPZESTMONEY',
                    'EW88GSRGJADGMO/RAZPEARLYSALARY','CMS/000650117100/BAJAJ_AUTO_CD__4F50CD34 442335',
                    'UPI/017016955251/UPI Collect req/cashe@kotak/Kotak Mahindra/','TO TRANSFER- UPI/DR/015715788403/KISSHT /IDFB/kisshat@id/PAYM915-',
                    'IMPS OUTWARD ORG UPI To lazypay.payu@hdfcbank,REF NO - 012505389088, Upi Transaction','UPI/kreditbee.r/016180632926/Kreditbee',
                    'UPI-BAJAJFINANCELTD-BAJAJFINSERV@ABFSPAY-UTIB0000100-013311812828-COLLECT','ACH D- CTRAZORPAY-CTTATAAIAAEMNEMW1Z7RDQ']
...
final_dataframe = pd.DataFrame({'User IDs':np.array(final_users),'Account-No':np.array(account_nos),
...
#final_dataframe.to_csv('v1_narration.csv',index=False)

#print(final_dataframe)

for item in check_narration:
    if item in final_dataframe['Narration']:
        print('Yes')
